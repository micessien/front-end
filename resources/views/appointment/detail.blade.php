            ...
            <div class="row">
                <aside class="col-xl-3 col-lg-4" id="sidebar">
                    <div class="box_profile">
                        <figure>
                            <img src="{{ url('/images/delta.jpg') }}" alt="" class="img-fluid">
                        </figure>
                        <small>SHANAHAN LTD</small>
                        <h1>Miss Kasey McDermott Astrid Berge</h1>
                        <span class="rating">
                        ...
                        <ul class="contacts">
                            <li><h6>Address</h6> Makayla Hollow 88477 South Violachester</li>
