    ...
    <div class="tabs_styled_2">
      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="book" role="tabpanel" aria-labelledby="book-tab">
          <p
            class="lead add_bottom_30"
          >Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget blandit nunc tortor eu nibh. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
          ...
          <center>
            <input type="submit" value="Book Now" class="btn_1 medium text-center">
          </center>
          <!-- </form> -->
          <hr>
        </div>
        ...
        <div class="tab-pane fade" id="general" role="tabpanel" aria-labelledby="general-tab">
          ...
          <div class="wrapper_indent">
            ...
            <ul class="list_edu">
              ...
              <li>
                <strong>Montefiore Medical Center</strong> - Residency in Internal Medicine
              </li>
              <li>
        ...
        <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
          ...
          <div class="text-right">
            <a href="#" class="btn_1 add_bottom_15">Submit review</a>
          </div>
        </div>
        <!-- /tab_3 -->
      </div>
